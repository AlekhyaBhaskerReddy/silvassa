...
public class POSHourlyReport extends BaseTestReport {
    ...
    public void downloadPosHourlyTwoWCSV() {
        try {
            Thread.sleep(4000);
            WebElement dataTableButtons = driver.findElement(By.id("posCsvBtn"));
            dataTableButtons.click();
            ...
            System.out.println("CSV button not found: " + resultDescription);
            if (title.equals("Error")) {
                extentReports.createTest("CSV Download in POS Hourly Report").log(Status.INFO,
                        "CSV button not found: " + resultDescription + " Status: " + title + ", Description: "
                                + resultDescription);
                driver.findElement(By.className("swal2-confirm")).click();
            } else {
                extentReports.createTest("CSV Download in POS Hourly Report").log(Status.PASS,
                        "Successfully downloaded the csv file.");
            }
